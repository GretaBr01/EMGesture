...
void loop(){
  ...
  switch (state_core0){
    case  STATE_CORE0_INIT:
      Serial.printf("imu_level_queue %d, adc_level_queue %d, ",imu_level_queue,adc_level_queue);
      Serial.printf("imu_data_core0_count %d, adc_data_core0_count %d, \n",imu_data_core0_count,adc_data_core0_count);
    ...
    case STATE_CORE0_PREPARING_STOP:
      ...
      Serial.printf("imu_level_queue %d, adc_level_queue %d, ",imu_level_queue,adc_level_queue);
      Serial.printf("imu_data_core0_count %d, adc_data_core0_count %d, ",imu_data_core0_count,adc_data_core0_count);
      Serial.printf("new state core 0 %d\n", state_core0);
