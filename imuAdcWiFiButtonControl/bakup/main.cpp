...
#define N_ADC_SAMPLE_PACKET 100
...
#define N_IMU_SAMPLE_PACKET 3 //numero di campioni per canale che si metterà in un pacchetto -> 8pps
...
void loop(){
  ...
  if (queue_try_remove(&adc_queue, &adc_data)) {
    ...
    //Serial.printf("-- %d, %d, %d, %d\n", adc_data.adc[0], adc_data.adc[1], adc_data.adc[2], adc_data.adc[3]);
    ...
    //Serial.printf("%d, %d, %d, %d, %d, %d\n", adc_data_p.adc[0], adc_data_p.adc[1], adc_data_p.adc[2], adc_data_p.adc[3], adc_data_p.adc[4], adc_data_p.adc[5]);
